...
const aggregateAssignmentViewsCall = async (
  req,
  res,
  environment
) => {
  let queryString = queries.aggregateAssignmentViewsQuery(req.body, dbInfo, environment);
...
module.exports = aggregateAssignmentViewsCall;
