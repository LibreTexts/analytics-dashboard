...
export default function DataTable({
  ...
  var columns = [
    {
      Header: <Tippy content="Name" arrow={true}><Text>Name</Text></Tippy>,
      width: 250,
      accessor: idAccessor,
  ...
  if (tab === "student" && ltCourse) {
    ...
    columns[1].columns.push(
      {
        Header: <Tippy content={column2Label}><Text>{column2Label}</Text></Tippy>,
      ...
      {
        Header: <Tippy content={column3Label}><Text>{column3Label}</Text></Tippy>,
        headerClassName: "lt-data wordwrap",
        accessor: "viewCount",
      ...
      {
        Header: (
          <Tippy content="Unique Interaction Days"><Text>Unique Interaction Days</Text></Tippy>
        ),
        headerClassName: "lt-data wordwrap",
        accessor: "dateCount",
      ...
      {
        Header: <Tippy content="Hours on Site"><Text>Hours on Site</Text></Tippy>,
        headerClassName: "lt-data wordwrap",
  ...
  if (tab === "student" && (hasAdapt || adaptCourse)) {
    ...
    columns[ltCourse ? 2 : 1].columns.push(
      ...
      {
        Header: <Tippy content="Unique Assignments"><Text>Unique Assignments</Text></Tippy>,
        headerClassName: "adapt-data wordwrap",
      ...
      {
        Header: (
          <Tippy content="Most Recent Page Load"><Text>Most Recent Page Load</Text></Tippy>
        ),
        headerClassName: "adapt-data wordwrap",
