  ...
  render() {
    ...
    if (this.props.ltCourse) {
      columns.push(
        ...
        {
          Header: <Tip content="Hours on Site">Hours on Site</Tip>,
          headerClassName: "lt-data",
    ...
    if (this.props.hasAdapt) {
      ...
      columns.push(
        ...
        {
          Header: (
            <Tip content="Average Percent Per Assignment">
              Average Percent Per Assignment
            </Tip>
          ),
          headerClassName: "adapt-data",
        ...
        {
          Header: (
            <Tip content="Average Attempts Per Assignment">
              Average Attempts Per Assignment
            </Tip>
          ),
          headerClassName: "adapt-data",
